...
impl BuildCommandService {
    pub fn run_build(&mut self, crate_path: &str) {
        ...
        let public_path = self.get_public_path(&release_key, &app.public_name);
        ...
        BuildCommandService::force_build(crate_path, &cargo_toml);
    ...
    fn force_build(crate_path: &str, cargo_toml: &CargoToml) {
