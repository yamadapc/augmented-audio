...
use metal::{
    BinaryArchive, BinaryArchiveDescriptor, Device, Library, MTLClearColor, MTLLoadAction,
    MTLPixelFormat, MTLPrimitiveType, MTLResourceOptions, MTLStoreAction, MetalLayer,
