...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall {
            ffi_looper_4db6_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0)
        }
    }
    ...
    func deallocate() {
        try! rustCall {
            ffi_looper_4db6_rustbuffer_free(self, $0)
        }
    }
}
...
public func initializeLogger() {
    ...
    rustCall {
        looper_4db6_initialize_logger($0)
    }
}

public protocol LooperEngineProtocol {
    func start()
}

public class LooperEngine: LooperEngineProtocol {
    ...
    public convenience init() {
        ...
        rustCall {
            looper_4db6_LooperEngine_new($0)
        })
    }

    deinit {
        try! rustCall {
            ffi_looper_4db6_LooperEngine_object_free(pointer, $0)
        }
    }
    ...
    public func start() {
        try!
        rustCall {
            looper_4db6_LooperEngine_start(self.pointer, $0)
        }
    }
}

private extension LooperEngine {
...
// """
extension LooperEngine: ViaFfi, Serializable {
}
...
// Helper code for LooperEngine class is found in ObjectTemplate.swift
