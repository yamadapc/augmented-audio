//
//  Sequencer_AudioUnitDSPKernel.hpp
//  Sequencer AudioUnit
//
//  Created by Pedro Tacla Yamada on 23/3/2022.
//

#ifndef Sequencer_AudioUnitDSPKernel_hpp
#define Sequencer_AudioUnitDSPKernel_hpp
...
/*
 Sequencer_AudioUnitDSPKernel
 Performs simple copying of the input signal to the output.
 As a non-ObjC class, this is safe to use from render thread.
 */
class Sequencer_AudioUnitDSPKernel : public DSPKernel {
public:
...
#endif /* Sequencer_AudioUnitDSPKernel_hpp */
